...
const features = [
  {
    ...
    desc: 'Visão diária e semanal com sistema anti-conflito e buffer time automático entre atendimentos.',
    tag: 'Agenda',
    accentColor: '#3B82F6',
  ...
  },
  {
    ...
    desc: 'Confirmações automáticas 24h e 2h antes do serviço via templates oficiais. Reduza o no-show drasticamente.',
    tag: 'Comunicação',
    accentColor: '#10B981',
  ...
  },
  {
    ...
    desc: 'Cálculo automático de comissões por profissional ao concluir a comanda. Fluxo de caixa e DRE em tempo real.',
    tag: 'Finanças',
    accentColor: '#8B5CF6',
  ...
  },
  {
    ...
    desc: 'Controle de entrada, saída e perda. Alertas de estoque mínimo integrados ao motor de vendas de produtos.',
    tag: 'Logística',
    accentColor: '#F97316',
  ...
  },
  {
    ...
    desc: 'Dashboard completo com top clientes, serviços mais lucrativos e ranking de performance dos profissionais.',
    tag: 'Analytics',
    accentColor: '#EC4899',
  ...
  },
  {
    ...
    desc: 'Abra pedidos, adicione produtos e serviços e feche pagamentos parciais ou totais com 1 clique no PDV.',
    tag: 'Vendas',
    accentColor: '#FACC15',
